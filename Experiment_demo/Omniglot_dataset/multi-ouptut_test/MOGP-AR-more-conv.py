...
from MOGP_convolutionalKernel.Building_Models import Build_MOGPAR_Conv_outputs ## Model
from MOGP_convolutionalKernel.Load_data import Save_result_more_output,prepare_data_list ## Dataset
from MOGP_convolutionalKernel.Load_data import Find_optimal_U_MOGP_AR_Conv, Load_Omniglot_data_from_directory
# reproducibility
import random
random.seed(3)
np.random.seed(1)
...
def Run_model(X,Y):
    ...
    for i in range(Num_cv):
        ...
        Optimal_Num_u_MOGP_AR= Find_optimal_U_MOGP_AR_Conv(Num_output, Xtrain_all, Ytrain_all, i, args.Num_U_CV, args.ns,
                               args.whole_latent_f, args.num_sample, args.num_latent_f_list, args.num_output,
                               minibatch_size, Num_class, maxiter, args.cv_measure, args.patch1, args.patch2, args.Maximum_induc_patch)
        ...
        #### Building our model ###
        ###########################
        MOGP_AR = Build_MOGPAR_Conv_outputs(X_train_data,
                                           ...
                                           minibatch=minibatch_size,patch1 = args.patch1,
