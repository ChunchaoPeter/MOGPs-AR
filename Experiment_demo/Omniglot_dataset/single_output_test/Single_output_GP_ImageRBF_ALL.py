...
def Run_model(X,Y):
    ...
    for train_index, test_index in sfolder.split(X, Y):
        ...
        ### GPAR
        a_GPAR = time.time()
        GPAR, data_GPAR, N_GPAR = Build_GP_AR_RBF(Xtrain, Ytrain, Num_classes=args.Num_classes, Num_inducing_point=args.Num_inducing_point)
        ...
        ### GPC
        a_GPC = time.time()
        GPC, data_GPC, N_GPC = Build_GPC_RBF(Xtrain, Ytrain, Num_classes=args.Num_classes, Num_inducing_point=args.Num_inducing_point)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--Num_classes', type=int, default=6, help='The number of class for single output')
    parser.add_argument('--Num_inducing_point', type=int, default=6, help='The number of class for single output')
